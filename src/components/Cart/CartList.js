					...
					<div className='pa3 ma2'>
						...
						<Popup
						    trigger={<input 
						            ...
						            className="br3 pa3 ma2 b ph3 pv2 input-reset ba b--black bg-transparent bg-light-green grow pointer f2 dib" 
						            type="submit" 
						  ...
						  >
						    {close => (
						      <div className="modal tc dib br3 grow bw2 shadow-5">
